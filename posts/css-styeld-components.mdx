...
date: "2023-03-23"
description: styled-components 를 사용해보자
tag: CSS
---
...
자바스크립트 파일(코드) 안에서 **css** 문법을 사용 할 수 있는 라이브러리 입니다.
...
Button 이라는 컴포넌트를 만드는데 styled 컴포넌트이며 a태그 입니다. 그리고 아래와 같은 스타일을 가진 컴포넌트란 뜻 입니다.
...
<iframe
    src="https://codesandbox.io/embed/styled-components-9spv5b?fontsize=14&hidenavigation=1&theme=dark"
    width="100%"
    height="500px"
></iframe>
